...
draw.rectangle((0, 0, 15, 15), fill=(0, 0, 0), outline=(0, 0, 255))
draw.line((0, 0, 15, 15), fill=(255, 0, 0))
draw.line((0, 15, 15, 15), fill=(0, 255, 0))

# Then scroll image across matrix...
for n in range(0, 32):  # Start off top-left, move off bottom-right
    matrix.Clear()
